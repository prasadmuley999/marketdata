...
# Input base workbook generated by upstream steps
INPUT_FILE = "NSE_Merged_Reports.xlsx"

# Dynamic output workbook name with current date for GitHub Action attachments
CURRENT_DATE_STR = datetime.now().strftime('%Y-%m-%d')
OUTPUT_FILE = f"NSE_Merged_Reports_{CURRENT_DATE_STR}.xlsx"
...
def generate_dashboard():
    # Verify presence of the base report file in workspace
    if not os.path.exists(INPUT_FILE):
        print(f"Error: '{INPUT_FILE}' not found. Please verify your GitHub Action workflow sequence.")
        return
    ...
    # --- FREEZE PANE SETUP ---
    # Locks Column A (Symbols) & Row 1 (Headers) while scrolling down/right
    ws.freeze_panes = 'B2'
    ...
    # 4. Save workbook with the distinct dated name for your runner output
    wb.save(OUTPUT_FILE)
    print(f"\nSuccess: 'Dashboard' sheet compiled into runner target file: '{OUTPUT_FILE}'!")
